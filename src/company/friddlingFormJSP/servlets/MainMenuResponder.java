package company.friddlingFormJSP.servlets;
...
public class MainMenuResponder extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		{
			response.sendRedirect("ListItems.html" + queryStringParams);
		}
		else if (userChoice.equals("2"))
		{
			response.sendRedirect("AddItem.html" + queryStringParams);
		}
		else if (userChoice.equals("3"))
		{
			response.sendRedirect("DeleteItem.html" + queryStringParams);
		}
		else
		{
			//invalid response
